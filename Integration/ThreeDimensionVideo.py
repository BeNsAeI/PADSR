...
import numpy
import math
from video3D_api import ThreeDimensionVideo
import cv2
...
tdv = ThreeDimensionVideo()
frameList_iter, depthmapList_iter = tdv.get_frame_data("data/test.mp4")
...
def main():
    ...
    vertex_shader = tdv.getVertexShader()
    fragment_shader = tdv.getFragmentShader()
...
def display():
    ...
    rgbData = tdv.getNextFrame(frameList_iter)
    depthData = tdv.getNextFrame(depthmapList_iter)
